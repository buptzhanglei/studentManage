		...
		<div class="superCtab">
			...
			<div class="ctab-Main">
				<div class="ctab-Main-title">
					<ul class="clearfix">
						<li><a href="manage">学生信息管理</a></li>
						<li class="cur"><a href="teacherManage">教师信息管理</a></li>
					</ul>
				</div>
				...
				<div class="ctab-Mian-cont">
					<div class="Mian-cont-btn clearfix">
						<div class="operateBtn">
							<a href="javascript:;" class="greenbtn add" onclick="addTeacher()">添加教师</a>
							<a href="javascript:;" class="greenbtn add" onclick="alert('功能待开发')">导入信息</a>
						</div>
						<div class="searchBar">
							<input type="text" id="searchContent" value="" class="form-control srhTxt" placeholder="输入标题关键字搜索">
...
<script>
	...
	$("#stdSearch").click(function(){
    	...
    	window.location = "teacherManage?content="+content;
    });
