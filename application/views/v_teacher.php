						...
						<table border="0" cellspacing="0" cellpadding="0" class="defaultTable defaultTable2">
							<tbody>
								...
								<tr>
									...
									<td class="t_1">
										<div class="btn" id="modify" onclick="modify('<?php echo $item["id"];?>')">
				...
				<table border="0" cellspacing="0" cellpadding="0" class="defaultTable">
					<tbody>
						...
						<tr>
							...
							<th class="t_1">上课时间</th>
							<th class="t_1">
								<select id="time" name="time" style="width:140px;height:40px">
								    <option value="0">请选择</option> 
...
<script>
	...
	$("#saveInfo").click(function(){
		...
		if(name=='' || assment=='' || course_grade=='' || time==''){
			alert("内容不能为空");die();
		}
		...
		$.ajax({
        	type:'post',
        	url:'saveInfo',
        	data:{user_id:$('#hiddenUserId').val(),name:name,assment:assment,course_grade:course_grade,time:time,type:type,class_id:class_id,username:username},
        	dataType:'json',
        	success: function(json){
        		if(json['code'] != 0){
        			alert(json['desc']);
